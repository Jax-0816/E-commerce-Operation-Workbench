  ...
  return (
    <Routes>
      <Route element={<WorkbenchShell productsApi={dependencies.productsApi} />}>
        ...
        />
        <Route
          path="capabilities/settings"
          element={
            <ProductFeature title="系统设置">
              <SystemSettingsPanel api={dependencies.systemStatusApi} />
            </ProductFeature>
          }
        />
        <Route
...
function TitlesPage({ api }: { readonly api: TitlesApi }): React.JSX.Element {
  return (
    <ProductFeature title="标题 Studio">
      <TitleStudio api={api} productId={useProductId()} />
    </ProductFeature>
  );
}
